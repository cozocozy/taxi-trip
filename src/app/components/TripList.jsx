...
const TripList = ({
  ...
  return (
    <div className="p-4 bg-gradient-to-br from-indigo-500 from-10% via-sky-500 via-30% to-purple-500 to-90% text-white overflow-y-auto mx-auto shadow-xl shadow-indigo-900/50">
